    ...
    public function display_form($type){
	    if ($type == 'account') {
            ...
            <form class="uwp-account-form uwp_form mt-3" method="post" enctype="multipart/form-data">
                ...
                <input name="uwp_account_submit" class="<?php echo $bs_btn_class; ?>" value="<?php _e( 'Update Profile', 'userswp' ); ?>" type="submit">
            </form>
	    <?php }
        ...
        if ($type == 'my-events') {
            ...
            <div class="book-box">
             <div class="row">
              <div class="col-lg-5 col-md-5"><img src="https://www.theshabbat.org/wp-content/uploads/2023/03/Jovani_012322_DennisG_2570_1500x.jpg" width="100%" /></div>
              <div class="col-lg-7 col-md-7">
               ...
               <a href="#">More Info</a> <a href="#">Book Now</a>  
              </div>
             </div>
            </div>
