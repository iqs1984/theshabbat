...
<img alt="pro-banner" class="pro-banner-1" width="100%" src="https://www.theShabbat.org/wp-content/uploads/2023/03/event_banner.jpg" />

<?php if(is_user_logged_in()) { ?>
	<div class="event-btn"><a href="https://www.theshabbat.org/my-events/?action=edit">Add Events</a></div>
<?php }else{ ?>
	<div class="event-btn"><a href="https://www.theshabbat.org/login">Add Events</a></div>
<?php } ?>
