                    ...
                    <div class="bg-light pt-5 h-100">
                        <div class="d-flex justify-content-center flex-column align-items-center">
							...
							echo aui()->button( array(
								'type'    => 'a',
								'href'    => get_author_posts_url($user_id).'?category='.$multiple_category[0],
...
<script>
	...
	{
		var succ_div = jQuery('.alert-success');
		if(succ_div.length > 0){
			window.location = 'https://www.theshabbat.org/account';
		}
	});
</script>