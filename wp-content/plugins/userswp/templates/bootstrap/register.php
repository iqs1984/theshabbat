...
<script>
	jQuery(document).ready(function()
	{
		...
		if(successDiv.length > 0){
			jQuery(".uwp-registration-form.uwp_form").hide();
			jQuery(".uwp-footer-links").hide();

		}else{
			jQuery(".uwp-registration-form.uwp_form").show();	
			jQuery(".uwp-footer-links").show();
		}
	});
</script>