...
define( 'WPFORMS_FORM_LOCKER_VERSION', '2.4.0' );
...
function wpforms_form_locker_fail_wpforms_version() {
	...
	printf( /* translators: Minimum required WPForms version. */
		esc_html__( 'The WPForms Form Locker plugin has been deactivated because it requires WPForms v%s or later to work.', 'wpforms-form-locker' ),
		'1.7.6'
	);
