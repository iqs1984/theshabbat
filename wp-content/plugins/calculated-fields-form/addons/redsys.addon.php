...
if( !class_exists( 'CPCFF_SabTPV' ) )
{
    class CPCFF_SabTPV extends CPCFF_BaseAddon
    {
		...
		public function get_addon_form_settings( $form_id )
		{
			...
			?>
			<div id="metabox_redsys_addon_form_settings" class="postbox cff-add-on-settings <?php print esc_attr(__CLASS__); ?> cff-metabox <?php print esc_attr($cpcff_main->metabox_status( 'metabox_redsys_addon_form_settings' ) ); ?>" >
